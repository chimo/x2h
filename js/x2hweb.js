/*global JSZip: false, MozBlobBuilder: false, WebKitBlobBuilder: false, FileError: false, FileReader: false, Worker: false, Uint8Array: false */
(function () {
    'use strict';
    ...
    var x2hweb = {
        ...
        init: function () {
            ...
            if (inpt.type === 'file') { // If the browser supports <input type="file">
                input = true;
            ...
            x2hweb.worker.addEventListener('message', function (e) {
                ...
                // Print messages
                for (i = 0, len = e.data.msgs.length; i < len; i += 1) {
                ...
                reader.onload = (function (theFile) { // TODO: Use addEventListener
                    return function (e) {
                        ...
                        try {
                            ...
                            json = {xhtml: e.target.result, filename: theFile.name};
    ...
    window.x2hweb = x2hweb;
    return window.x2hweb;
}().init());